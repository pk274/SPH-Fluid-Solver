...
class Renderer {
  public:
	...
	void update_information(sf::Time time, int numParticles, int numFluidParticles, float numUpdates, float avgDensity = -1, float maxStep = -1, float watchedParticleDensity = -1);
